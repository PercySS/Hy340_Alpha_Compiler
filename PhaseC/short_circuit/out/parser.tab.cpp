...
{
       0,   160,   160,   165,   179,   187,   194,   202,   209,   217,
     225,   233,   240,   248,   253,   262,   278,   284,   288,   294,
     301,   308,   315,   322,   329,   335,   341,   347,   377,   408,
     408,   421,   421,   432,   439,   444,   452,   465,   480,   496,
     511,   527,   533,   570,   575,   580,   585,   590,   596,   633,
     664,   684,   690,   695,   703,   708,   713,   718,   730,   738,
     743,   749,   758,   767,   779,   792,   798,   811,   824,   829,
     836,   860,   860,   875,   880,   885,   890,   897,   949,   957,
     963,   988,   994,  1000,  1006,  1012,  1018,  1025,  1059,  1092,
    1098,  1111,  1117,  1122,  1129,  1134,  1138,  1149,  1153,  1168,
    1177,  1183,  1188,  1205,  1218,  1230,  1241,  1258,  1270,  1276,
    1282,  1288
};
#endif
...
static const yytype_int16 yypact[] =
{
    ...
    -175,  -175,  -175,  -175,  -175,  -175,  -175,    83,    19,    39,
     ...
     393,   393,  -175,  -175,  -175,   482,  -175,  -175,  -175,   662,
...
#line 347 "src/parser.y"
                                {       
                                        ...
                                        emit(if_eq, (yyvsp[-2].expr), (yyvsp[0].expr), nullptr, 0);
...
#line 377 "src/parser.y"
                                {       
                                        ...
                                        (yyval.expr)->truelist.push_back(nextquad() - 1);
                                        emit(if_noteq, (yyvsp[-2].expr), (yyvsp[0].expr), nullptr, 0);
                                        (yyval.expr)->falselist.push_back(nextquad() - 1);
                                        emit(jump, nullptr, nullptr, nullptr, 0);
...
#line 1188 "src/parser.y"
                                                                        {       
                                                                                ...
                                                                                if ((yyvsp[-4].expr)->type == boolexpr_e) {                                                                                        
                                                                                        backpatch((yyvsp[-4].expr)->truelist, nextquad());
                                                                                        backpatch((yyvsp[-4].expr)->falselist, nextquad() + 2);
...
#line 3380 "out/parser.tab.cpp"
    break;


#line 3384 "out/parser.tab.cpp"
