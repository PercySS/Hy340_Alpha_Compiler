...
expr:   assignexpr              {       
        ...
        |expr AND expr          {       
                                        expr* temp1 = convert_to_bool($1);
                                        expr* temp2 = convert_to_bool($3);
                                        
                                        $$ = newexpr(boolexpr_e);
                                        $$->sym = newtemp();
                                        emit(and_op, temp1, temp2, $$, 0);
...
funcname: IDENTIFIER            {       
        ...
        | /* empty */           {       
                                        $$ = strdup(generateAnonymousName().c_str());
