  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_PLUS = 3,                              // PLUS
        S_MINUS = 4,                             // MINUS
        S_MULTIPLY = 5,                          // MULTIPLY
        S_DIVIDE = 6,                            // DIVIDE
        S_MODULO = 7,                            // MODULO
        S_LESS_THAN = 8,                         // LESS_THAN
        S_LESS_THAN_EQUAL = 9,                   // LESS_THAN_EQUAL
        S_GREATER_THAN = 10,                     // GREATER_THAN
        S_GREATER_THAN_EQUAL = 11,               // GREATER_THAN_EQUAL
        S_EQUAL = 12,                            // EQUAL
        S_NOT_EQUAL = 13,                        // NOT_EQUAL
        S_INCREMENT = 14,                        // INCREMENT
        S_DECREMENT = 15,                        // DECREMENT
        S_ASSIGN = 16,                           // ASSIGN
        S_PLUS_ASSIGN = 17,                      // PLUS_ASSIGN
        S_MINUS_ASSIGN = 18,                     // MINUS_ASSIGN
        S_SEMICOLON = 19,                        // SEMICOLON
        S_COMMA = 20,                            // COMMA
        S_COLON = 21,                            // COLON
        S_DOUBLE_COLON = 22,                     // DOUBLE_COLON
        S_DOT = 23,                              // DOT
        S_DOUBLE_DOT = 24,                       // DOUBLE_DOT
        S_TURNARY = 25,                          // TURNARY
        S_LEFT_PARENTHESIS = 26,                 // LEFT_PARENTHESIS
        S_RIGHT_PARENTHESIS = 27,                // RIGHT_PARENTHESIS
        S_LEFT_BRACE = 28,                       // LEFT_BRACE
        S_RIGHT_BRACE = 29,                      // RIGHT_BRACE
        S_LEFT_BRACKET = 30,                     // LEFT_BRACKET
        S_RIGHT_BRACKET = 31,                    // RIGHT_BRACKET
        S_IF = 32,                               // IF
        S_ELSE = 33,                             // ELSE
        S_WHILE = 34,                            // WHILE
        S_FOR = 35,                              // FOR
        ...
        S_IGNORED = 51,                          // IGNORED
        S_LOWER_THAN_ELSE = 52,                  // LOWER_THAN_ELSE
        S_UMINUS = 53,                           // UMINUS
        ...
        S_member = 63,                           // member
        S_call = 64,                             // call
        S_callsuffix = 65,                       // callsuffix
        S_normcall = 66,                         // normcall
        S_methodcall = 67,                       // methodcall
        S_elist = 68,                            // elist
        S_objectdef = 69,                        // objectdef
        S_indexed = 70,                          // indexed
        S_indexedelem = 71,                      // indexedelem
        S_block = 72,                            // block
        S_funcdef = 73,                          // funcdef
        S_const = 74,                            // const
        S_idlist = 75,                           // idlist
        S_ifstmt = 76,                           // ifstmt
        S_whilestmt = 77,                        // whilestmt
        S_forstmt = 78,                          // forstmt
        S_returnstmt = 79                        // returnstmt
      };
    };
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::YYEOF
                   ...
                   || (token::IGNORED <= tok && tok <= token::UMINUS));
#endif
      }
#if 201103L <= YY_CPLUSPLUS
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_DOUBLE_DOT ()
      {
        return symbol_type (token::DOUBLE_DOT);
      }
#else
      static
      symbol_type
      ...
      make_TURNARY ()
      {
        return symbol_type (token::TURNARY);
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::LEFT_PARENTHESIS);
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::RIGHT_PARENTHESIS);
      }
#else
      static
      symbol_type
      ...
      make_IGNORED ()
      {
        return symbol_type (token::IGNORED);
      }
#else
      static
      symbol_type
